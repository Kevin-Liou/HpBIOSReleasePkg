# Make Release Pkg Script For AMD.   0.0.6
# Author: Kevin Liou
...
Removefilerule=["DCI.7z", ".xlsm", ".cat", ".cer", ".pfx", ".pvk", \
...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script For AMD   0.0.6".center(90, "="))
    ...
    for NProc in NewProcPkgInfo:# Pkg Modify Update Version
        ...
        if os.path.isdir(Path+"\\AMDFLASH"):# Check Folder Exist
            ...
            for Filename in Versionfilelist:
                ...
                if NProc[0]+"_"+OldVersion+".bin" in Strlist:
                    for Str in range(len(Strlist)):
                        if Strlist[Str]==NProc[0]+"_"+OldVersion+".bin":
                            Strlist[Str]=NProc[0]+"_"+NewVersion+".bin"
                elif NewVersion in Strlist:
                    print("Now Pkg Version is already "+Strlist[4]+".")
                    File.close()
                    break
                else:
                    print("Old Version "+OldVersion+" Can't find, Now Pkg Version is "+Strlist[4]+".")
                    File.close()
                    break
