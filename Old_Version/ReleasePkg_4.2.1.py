...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   4.2.1".center(90, "="))
    ...
    for NProc in NewProcPkgInfo:# Pkg Modify Update Version
        ...
        #======For AMD
            ...
            if os.path.isdir(Path+"\\AMDFLASH"):# Check Folder Exist
                ReleaseNote_docx = [ReleaseNote for ReleaseNote in os.listdir(Path) if "Release_Notes.docx" in ReleaseNote]
                ReleaseNote_xlsm = [ReleaseNote for ReleaseNote in os.listdir(Path) if "Release_Note_"+OldVersion+".xlsm" in ReleaseNote]
                if len(ReleaseNote_docx)==1:
                    os.chdir(Path)
    ...
    for NProc in NewProcPkgInfo:
        ...
        if os.path.isdir(".\\"+targetfolder):
            RemoveOldFileInDir(targetfolder, OldVersion, Removefilerule, NotRemovefilerule)
        else:   print("Pkg "+("_").join(NProc)+" can't find.\n")
    ...
    if Platform_Flag(OldProcPkgInfo) == "Intel" or Platform_Flag(OldProcPkgInfo) == "Intel G3":
        ...
        CheckBiosBuildDate(Matchfolderlist)
