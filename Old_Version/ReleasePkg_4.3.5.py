...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   4.3.5".center(90, "="))
    ...
    for Project in ProcessProjectList:
        temp=[]
        #======For Intel
        if (Platform_Flag(Project) == "Intel G5") or (Platform_Flag(Project) == "Intel G4") or (Platform_Flag(Project) == "Intel G3"):
    ...
    for OldProcPkg in OldProcPkgInfo:
        #======For Intel
        if (Platform_Flag(OldProcPkg) == "Intel G5") or (Platform_Flag(OldProcPkg) == "Intel G4") or (Platform_Flag(OldProcPkg) == "Intel G3"):
    ...
    for NProc in NewProcPkgInfo:# Pkg Modify Update Version
        #======For Intel
        if (Platform_Flag(NProc) == "Intel G5") or (Platform_Flag(NProc) == "Intel G4") or (Platform_Flag(NProc) == "Intel G3"):
    ...
    try:
        for NProc in NewProcPkgInfo:
            #======For Intel G5
            if Platform_Flag(NProc) == "Intel G5" and os.path.isdir(".\\"+("_").join(NProc)+"\\Capsule\\CCG5\\CCG5C"):
    ...
    print("End".center(90, "="))
    #======For Intel Check
    if (Platform_Flag(OldProcPkgInfo) == "Intel G5") or (Platform_Flag(OldProcPkgInfo) == "Intel G4") or (Platform_Flag(OldProcPkgInfo) == "Intel G3"):
