# Make Release Pkg Script For AMD.   0.0.1
# Author: Kevin Liou
...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script For AMD   0.0.1".center(90, "="))
    ...
    for Project in range(len(NewProcPkgInfo)):# ['Q26', '01.04.01']=>['ScottyRr', 'ScottyRr', 'Q26', '01.04.01']
    ...
    for project in range(0, len(NewProcPkgInfo)):# ['ScottyRr', 'ScottyRr', 'Q26', '01.04.01']=>['Q26', '01.04.01']
