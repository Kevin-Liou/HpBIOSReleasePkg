...
BoardID=["P10","Q10","Q11","Q21~23","Q26","Q27","R11","R21~23","R26","S21~23"]
...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   4.3.8".center(90, "="))
    ...
    print("End".center(90, "="))
    #======For Intel Check
    if (Platform_Flag(OldProcPkgInfo) == "Intel G3") or (Platform_Flag(OldProcPkgInfo) == "Intel G4") or (Platform_Flag(OldProcPkgInfo) == "Intel G5") or (Platform_Flag(OldProcPkgInfo) == "Intel G6"):
