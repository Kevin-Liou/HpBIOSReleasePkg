...
Removefilerule=["DCI.7z", ".xlsm", ".cat", ".cer", ".pfx", ".pvk", "_12.bin", "_16.bin",\
...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   3.0.3".center(90, "="))
    ...
    for NProc in NewProcPkgInfo:# Pkg Modify Update Version
        ...
        if os.path.isdir(Path+"\\FPTW"):# Check Folder Exist
            ...
            if len(ReleaseNote)==1:
                ...
                print("Can't find release note.docx")
            os.chdir(Path+"\\FPTW")
        ...
        for NProc in NewProcPkgInfo:
            if Fv.split("_")[1]==NProc[2]:
                if os.path.isdir(".\\"+Fv):
                    ...
                    if os.path.isfile(".\\"+Fv+"\\"+Boardversion+"_16.bin"):# For 16MB BIOS
