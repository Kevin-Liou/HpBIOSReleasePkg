...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   3.1.0".center(90, "="))
        ...
        for NProc in NewProcPkgInfo:
            if Fv.split("_")[1] == NProc[2]:
                if os.path.isdir(".\\"+Fv):
                    ...
                    if os.path.isfile(Path + "\\" + Boardversion + "_16.bin") or os.path.isfile(Path + "\\" + Boardversion + "_32.bin"):
