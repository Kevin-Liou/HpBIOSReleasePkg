...
Removefilerule=["DCI.7z", ".cer", ".pfx", ".pvk", r"\d{6}.cat", r"\w\d{2}_\d{4}.cat", r"P00\w{3}-\w{3}.zip", r"Pvt.bin",
                r"\d\d_\d\d_\d\d.bin", r"\d\d_\d\d_\d\d.cat", r"\d\d_\d\d_\d\d.inf", r"Build.Log",
                r"\w\d{2}_\d{6}.xml", r"\w\d{2}_\d{4}.xml", ".xlsm", r"metainfo.xml",
...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   4.3.3".center(90, "="))
