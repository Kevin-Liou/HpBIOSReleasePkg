...
if __name__ == '__main__':
    ...
    #=================Script Start==========================================================
    print("Make Release Pkg Script   4.3.0".center(90, "="))
    ...
    for Fv in Matchfolderlist:
        for NProc in NewProcPkgInfo:
            #======For Intel
            if Platform_Flag(NProc) == "Intel" or Platform_Flag(NProc) == "Intel G3":
                if Fv.split("_")[1] == NProc[2] and os.path.isdir(".\\" + Fv):
                    Path = ".\\" + Fv
            ...
            #======For AMD
                ...
                if Fv.split("_")[1] == NProc[0] and os.path.isdir(".\\" + Fv):
                    Path = os.getcwd()+"\\" + Fv
